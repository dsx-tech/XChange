...
public class KrakenFuturesDigest implements ParamsDigest {
    ...
    public String digestParams(RestInvocation restInvocation) {
        Map<String, String> headersMap = restInvocation.getParamsMap().get(HeaderParam.class).asHttpHeaders();
        Map<String, String> queryParamsMap = restInvocation.getParamsMap().get(QueryParam.class).asHttpHeaders();
        String postData = queryParamsMap.entrySet().stream()
