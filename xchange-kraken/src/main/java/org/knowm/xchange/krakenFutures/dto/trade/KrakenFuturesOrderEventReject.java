...
public class KrakenFuturesOrderEventReject extends KrakenFuturesOrderEvent {
   ...
   * iocWouldNotExecute: the immediate-or-cancel order would not execute. wouldNotReducePosition:
   * the reduce only order would not reduce position. orderForEditNotFound: the order for edit was
   * not found. The order field will be null in this case
   */
