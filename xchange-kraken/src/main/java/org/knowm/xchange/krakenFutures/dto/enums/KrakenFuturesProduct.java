...
public enum KrakenFuturesProduct {
  ...
  public static final DateTimeFormatter MATURITY_DATE_FORMAT =
      DateTimeFormatter.ofPattern("yyMMdd");
  private static final String PRODUCT_DELIMITER_CHAR = "_";
  ...
  public String formatProductId(CurrencyPair pair, LocalDate maturityDate) {
    if (maturityDate != null && mustHaveMaturityDate) {
      return formatProductId(pair)
          + PRODUCT_DELIMITER_CHAR
          + MATURITY_DATE_FORMAT.format(maturityDate);
    }
    return formatProductId(pair);
  }
  ...
  public String formatProductId(CurrencyPair pair) {
    return this.name()
        ...
        + StringUtils.upperCase(
            StringUtils.upperCase(pair.base.toString() + pair.counter.toString()));
  }

  public static ImmutableTriple<KrakenFuturesProduct, CurrencyPair, LocalDate> parseProductId(
      String productId) {
    if (productId != null) {
