...
public class KrakenFuturesAccount {
  ...
  /**
   * The currency of the account. All figures shown in auxiliary and marginRequirements are in this
   * currency. Returned only for margin accounts
   */
  @JsonDeserialize(keyUsing = CurrencyDeserializer.class)
  private Currency currency;

  /** A structure containing auxiliary account information. Returned only for margin accounts */
  private KrakenFuturesAuxiliaryAccount auxiliary;

  /** A structure containing the account’s margin requirements, returned only for margin accounts */
  private KrakenFuturesAccountMarginRequirements marginRequirements;

  /**
   * A structure containing the account’s margin trigger estimates, returned only for margin
   * accounts
   */
