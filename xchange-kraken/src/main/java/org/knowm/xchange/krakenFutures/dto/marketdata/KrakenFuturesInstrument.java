...
public class KrakenFuturesInstrument {
  ...
  /**
   * The type of the instrument, either futures_inverse, futures_vanilla, turbo_inverse, spot index
   * or volatility index
   */
  ...
  /**
   * For Futures: The date and time at which the Futures stops trading For indices: Not returned
   * because N/A
   */
  private Date lastTradingTime;

  /** For Futures: The tick size increment of the Futures For indices: Not returned because N/A */
  private BigDecimal tickSize;

  /**
   * For Futures: For Futures: The contract size of the Futures For indices: Not returned because N/
   */
