...
public class FuturesMarketDataTest {
  /**
   * account: go858ujj@futures-demo.com ac9gypodsbqmse3413x1hs
   *
   * <p>Demo Api Key SEpLe3MiVCPWQqVIXObDzhCKQIh3IQcfiM/OeUr+9JS5hykZQw1jl6UF
  ...
  public void tickerFetchTest() throws Exception {
    ...
    ExchangeSpecification exchangeSpecification =
        new ExchangeSpecification(KrakenFuturesExchange.class);
    ...
    KrakenFuturesTradeServiceRaw tradeService =
        (KrakenFuturesTradeServiceRaw) exchange.getTradeService();
    KrakenFuturesAccountServiceRaw accountService =
        (KrakenFuturesAccountServiceRaw) exchange.getAccountService();
    ...
    KrakenFuturesResult withdrawalResult =
        accountService.withdrawalToSpotWallet(Currency.XBT, new BigDecimal("0.0001"));
    assertThat(withdrawalResult).isNotNull();

    KrakenFuturesResult transfer =
        accountService.transfer("cash", "fi_xrpusd", Currency.XRP, new BigDecimal("0.01"));
