...
public class KrakenFuturesProductTest {
    ...
    public void parseProductValidFI() {
        ImmutableTriple<KrakenFuturesProduct, CurrencyPair, LocalDate> result = KrakenFuturesProduct.parseProductId("fi_ethbtc_200311");
    ...
    public void parseProductValidPI() {
        ImmutableTriple<KrakenFuturesProduct, CurrencyPair, LocalDate> result = KrakenFuturesProduct.parseProductId("Pi_ethbtc");
