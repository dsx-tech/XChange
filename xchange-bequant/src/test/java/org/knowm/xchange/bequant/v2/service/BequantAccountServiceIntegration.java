 ...
 */
@Ignore
public class BequantAccountServiceIntegration extends BaseAuthenticatedServiceTest {

  private BequantAccountService service = (BequantAccountService) exchange.getAccountService();
  ...
  public void testGetFundingHistory() throws IOException {
    ...
    BequantFundingHistoryParams bequantTradeHistoryParams =
        BequantFundingHistoryParams.builder().build();

    List<FundingRecord> records = service.getFundingHistory(bequantTradeHistoryParams);
  ...
  public void testGetFundingHistory_withParams() throws IOException {
    ...
    BequantFundingHistoryParams bequantTradeHistoryParams =
        BequantFundingHistoryParams.builder().limit(2).build();
