...
public class BequantHmacDigest implements ParamsDigest {

  private static final String HMAC_SHA_512 = "HmacSHA512";
  private final Mac mac;

  private BequantHmacDigest(String secretKeyBase) throws IllegalArgumentException {
  ...
  public static BequantHmacDigest createInstance(String secretKeyBase) {

    return new BequantHmacDigest(secretKeyBase);
  }
