...
public class KrakenFuturesMarketDataDemo {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Ticker ticker = marketDataService.getTicker(CurrencyPair.XBT_USD, FI, LocalDate.of(20, 3, 27));
    ...
    OrderBook orderbook =
        marketDataService.getOrderBook(CurrencyPair.XBT_USD, FI, LocalDate.of(20, 3, 27));
    System.out.println(orderbook);

    Trades trades = marketDataService.getTrades(CurrencyPair.XBT_USD, FI, LocalDate.of(20, 3, 27));
